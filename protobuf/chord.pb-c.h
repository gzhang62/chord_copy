...
typedef struct NotifyResponse NotifyResponse;
typedef struct FindSuccessorRequest FindSuccessorRequest;
typedef struct FindSuccessorResponse FindSuccessorResponse;
typedef struct RFindSuccReq RFindSuccReq;
typedef struct RFindSuccResp RFindSuccResp;
typedef struct GetPredecessorRequest GetPredecessorRequest;
typedef struct GetPredecessorResponse GetPredecessorResponse;
typedef struct CheckPredecessorRequest CheckPredecessorRequest;
typedef struct CheckPredecessorResponse CheckPredecessorResponse;
typedef struct GetSuccessorListRequest GetSuccessorListRequest;
typedef struct GetSuccessorListResponse GetSuccessorListResponse;
typedef struct ChordMessage ChordMessage;
 ...
 * Check Predecessor
 */
struct  CheckPredecessorRequest
{
  ProtobufCMessage base;
};
...
struct  CheckPredecessorResponse
{
  ProtobufCMessage base;
};
 ...
 * Get Successor
 */
struct  GetSuccessorListRequest
{
  ProtobufCMessage base;
};
...
struct  GetSuccessorListResponse
{
  ProtobufCMessage base;
  size_t n_successors;
  Node **successors;
...
typedef enum {
  ...
  CHORD_MESSAGE__MSG_R_FIND_SUCC_RESP = 13
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CHORD_MESSAGE__MSG__CASE)
